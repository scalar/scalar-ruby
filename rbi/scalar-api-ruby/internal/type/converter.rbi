  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Scalar::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Scalar::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Scalar::Internal::Type::Converter::Input,
              value: T.anything,
              state: Scalar::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
          def self.coerce(
            ...
            state: Scalar::Internal::Type::Converter.new_coerce_state
          )
          end
